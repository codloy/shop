...
import { NestedCategory } from '@/types/NestedCategory';
...
export type AccountSellProductCreateSelectCategoryProps = {
  categorySlugs: string[];
  onCategorySlugs(categorySlugs: string[]): void;
};

export function AccountSellProductCreateSelectCategory(
  props: AccountSellProductCreateSelectCategoryProps
) {
